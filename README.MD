...
- **Banco de Dados**: [SQLite](https://sqlite.org/) - Banco de dados leve e embarcado em dev.
...
- **Autenticação**: [PyJWT](https://pypi.org/project/PyJWT/) para JWT e [bcrypt](https://pypi.org/project/bcrypt/) para hash de senhas.
...
- **Guia Completo**: [DOCS/AUTHENTICATION.MD](DOCS/AUTHENTICATION.MD) - Documentação detalhada sobre:
...
- **Guia Completo**: [DOCS/GENERIC-CRUD.MD](DOCS/GENERIC-CRUD.MD) - Documentacao detalhada sobre:
  - Como funciona o GenericController
  - Como sobrescrever metodos para validacoes
  - Exemplos praticos de customizacao (ex.: UserController)
